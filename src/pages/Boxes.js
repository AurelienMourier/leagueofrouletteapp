...
export default class Boxes extends Component 
{
    constructor(props) 
    {
        ...
        this.state = {
            openedBox : {},
            openedBoxCard: [],
            boxes: [{"id": 1, "name": "Coffre d'hiver", "description": "Coffre sur la saison hivernale", "price": 250, "cards": [
            ...
            {"id": 2, "name": "Coffre de sang", "description": "Un coffre sanglant...", "price": 300, "cards": [
            ...
            {"id": 3, "name": "Coffre du printemp", "description": "Coffre sur la saison printanière", "price": 250, "cards": [
            ...
            {"id": 4, "name": "Coffre obscure", "description": "Des ombres sortent de ce coffre...", "price": 350, "cards": [
                {"cardId": 1, "description": "Bouffon des ténébres", "imageUrl": "https://i.ibb.co/BV2g6qk/Shaco.jpg", "name": "Shaco", "rarityCard": "Super rare", "statCard": {"ad": 50, "ap": 0, "as": 50, "ar": 50, "mr": 0, "ms": 50}, "typeCard": "Support"},
            ...
            {"id": 5, "name": "Coffre lumineux", "description": "La lumière est aveuglante", "price": 350, "cards": [
            ...
            {"id": 6, "name": "Coffre d'automne", "description": "Coffre sur la saison automnale", "price": 250, "cards": [
            ...
            {"id": 7, "name": "Coffre de feu", "description": "Il sort tout droit des enfers...", "price": 350, "cards": [
    ...
    componentDidMount() {
        // Récupérer les box disponible depuis l'API (pour l'instant aucun coffre de créer car problème: à régler...)
    }
